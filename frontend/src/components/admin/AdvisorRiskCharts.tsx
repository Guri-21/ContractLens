...
import { AdvisorAnalyticsResponse, GlobalAnalyticsResponse } from '../../api/adminAnalytics';
  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      <PieChart>
        ...
        <RechartsTooltip formatter={(value: number, name: string) => [value, name.toUpperCase()]} />
        <Legend />
      </PieChart>
    </ResponsiveContainer>
  );
